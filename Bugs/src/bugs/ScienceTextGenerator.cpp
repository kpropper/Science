/*
	...
	ScienceTextGenerator.cpp

	See ScienceTextGenerator.h for a class description.
*/
...
void ScienceTextGenerator::appendPathfindingText(Game *game)
{
	wstringstream wss;
...
void ScienceTextGenerator::appendMouseCoords(Game *game)
{
	wstringstream wss;
...
void ScienceTextGenerator::appendEnemyLocation(Game *game)
{
	wstringstream wss;
	if (game->getGSM()->isGameInProgress())
	{
		...
		wss << L",  1- ";
		wss << game->getGSM()->getSpriteManager()->getNumberOfBotsInNode(1);
		wss << L", 2-";
		wss << game->getGSM()->getSpriteManager()->getNumberOfBotsInNode(2);
		wss << L", 3- ";
		wss << game->getGSM()->getSpriteManager()->getNumberOfBotsInNode(3);
		wss << L", 4- ";
		wss << game->getGSM()->getSpriteManager()->getNumberOfBotsInNode(4);
		wss << L"\n5- ";
		wss << game->getGSM()->getSpriteManager()->getNumberOfBotsInNode(5);
		wss << L", 6- ";
		wss << game->getGSM()->getSpriteManager()->getNumberOfBotsInNode(6);
		wss << L", 7- ";
		wss << game->getGSM()->getSpriteManager()->getNumberOfBotsInNode(7);
		wss << L", 8- ";
		wss << game->getGSM()->getSpriteManager()->getNumberOfBotsInNode(8);
		wss << L", 9- ";
		wss << game->getGSM()->getSpriteManager()->getNumberOfBotsInNode(9);
		wss << L"\n10 - ";
		wss << game->getGSM()->getSpriteManager()->getNumberOfBotsInNode(10);
		wss << L", 11- ";
		wss << game->getGSM()->getSpriteManager()->getNumberOfBotsInNode(11);
		wss << L", 12- ";
		wss << game->getGSM()->getSpriteManager()->getNumberOfBotsInNode(12);
		wss << L", 13- ";
		wss << game->getGSM()->getSpriteManager()->getNumberOfBotsInNode(13);
		wss << L", 14- ";
		wss << game->getGSM()->getSpriteManager()->getNumberOfBotsInNode(14);
		wss << L"\n 15- ";
		wss << game->getGSM()->getSpriteManager()->getNumberOfBotsInNode(15);
		wss << L", 16- ";
		wss << game->getGSM()->getSpriteManager()->getNumberOfBotsInNode(16);
		wss << L", 17- ";
		wss << game->getGSM()->getSpriteManager()->getNumberOfBotsInNode(17);
		wss << L", 18- ";
		wss << game->getGSM()->getSpriteManager()->getNumberOfBotsInNode(18);
		wss << L", 19- ";
...
void ScienceTextGenerator::appendAntRotationInfo(Game *game)
{
	wstringstream wss;
	TopDownSprite *ant = game->getGSM()->getSpriteManager()->getPlayer();
...
*/
void ScienceTextGenerator::initText(Game *game)
{
...
*/
void ScienceTextGenerator::updateText(Game *game)
{
